...
class CustomScaffold extends StatelessWidget {
  const CustomScaffold({Key? key, this.child})
      : super(key: key); // Construtor para o widget CustomScaffold
  // Construtor para o widget CustomScaffold

  final Widget? child; // Widget filho a ser exibido em cima da imagem de fundo
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        iconTheme: const IconThemeData(
            color: Colors
                .white), // Define a cor dos ícones na barra de aplicativos
